...
# def translate_text_external(text: str, target_language: str) -> str:
#     # Placeholder for real Google Cloud Translation integration.
...
#         "caption": get_or_create_translation(
#             db=db,
#             source_type="experience",
#             source_id=experience.id,
#             field_name="caption",
#             source_text=experience.caption,
#             target_language=target_language,
#         ),
#         "location": get_or_create_translation(
#             db=db,
#             source_type="experience",
#             source_id=experience.id,
#             field_name="location",
#             source_text=experience.location or "",
#             target_language=target_language,
#         ),
#         "target_language": target_language,
#     }