...
import { MapPin, Mail, Twitter, Youtube } from "lucide-react";
    ...
    <footer className="border-t border-slate-200 bg-slate-900 text-slate-400">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-12">
          ...
          {/* PROVIDER LINKS — only for providers */}
          {isProvider && (
            <div className="space-y-4">
              <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">
                Manage
              ...
              <div className="flex flex-col gap-3 text-sm">
                ...
                <Link href={ROUTES.providerExperiences} className="hover:text-orange-400 transition-colors">
                  My Experiences
                </Link>
                <Link href={ROUTES.providerPackages} className="hover:text-orange-400 transition-colors">
                  My Packages
                </Link>
                <Link href={ROUTES.providerBookings} className="hover:text-orange-400 transition-colors">
                  Bookings
                </Link>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 text-sm">
              {!isAuthenticated ? (
                ...
                <Link href={ROUTES.providerProfile} className="hover:text-orange-400 transition-colors">
                  My Profile
                </Link>
              ) : (
