...
export function TopNavbar({ onSearchOpen, mobileExtras }: TopNavbarProps) {
    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div
        className={`transition-all duration-300 border-b ${
          scrolled
            ? "bg-stone-900/95 backdrop-blur-xl border-white/10 shadow-sm"
            : "bg-stone-900/90 backdrop-blur-sm border-white/5"
        }`}
      >
            ...
            {isAuthenticated && user ? (
              ...
              <>
                ...
                <Link
                  ...
                  className="flex items-center gap-1 rounded-lg bg-amber-400 px-2.5 py-1.5 text-xs font-semibold text-stone-900 hover:bg-amber-300 transition-all"
                >
                  Get Started
                </Link>
              </>
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="lg:hidden bg-stone-900/95 backdrop-blur-xl border-b border-white/10 px-4 py-3 flex flex-col gap-1">
          ...
          {/* Sidebar extras injected from FeedLayout */}
          {mobileExtras && (
            <div className="border-t border-white/10 mt-1 pt-2 flex flex-col gap-1">
              {mobileExtras}
            </div>
          )}
