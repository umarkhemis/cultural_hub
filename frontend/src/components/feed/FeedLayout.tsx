  ...
  return (
    <div className="min-h-screen bg-stone-700">
      ...
      <div className="flex h-[calc(100vh-3.5rem)] mt-14">
        ...
        {/* Left sidebar — glassy transparent */}
        <aside className="hidden lg:flex w-72 h-full overflow-y-auto flex-col px-4 py-5 gap-5 shrink-0 bg-white/5 backdrop-blur-md border-r border-white/10">

          {/* Search */}
          <button
            onClick={() => setShowSearch(true)}
            className="flex items-center gap-2.5 w-full rounded-xl border border-white/10 bg-white/5 px-3.5 py-2.5 text-sm text-white/40 hover:border-white/20 hover:bg-white/10 transition-all text-left"
          >
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link
                ...
                className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-3.5 py-3 hover:border-amber-400/30 hover:bg-amber-400/10 transition-all group"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-400/20 shrink-0">
                  <Package className="h-4 w-4 text-amber-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-white/80 group-hover:text-amber-400">Browse Packages</p>
                  <p className="text-xs text-white/30">Tourism packages</p>
                </div>
              </Link>
              <Link
                href={ROUTES.packages}
                className="text-xs font-semibold text-amber-400/60 hover:text-amber-400 transition-colors px-1"
              >
                See more →
              </Link>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link
                href={ROUTES.sites}
                className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-3.5 py-3 hover:border-emerald-400/30 hover:bg-emerald-400/10 transition-all group"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-400/20 shrink-0">
                  <Globe className="h-4 w-4 text-emerald-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-white/80 group-hover:text-emerald-400">Explore Sites</p>
                  <p className="text-xs text-white/30">Cultural heritage</p>
                </div>
              </Link>
              <Link
                href={ROUTES.sites}
          ...
          {!isAuthenticated && (
            <div className="rounded-2xl bg-white/5 border border-white/10 px-4 py-4">
              <p className="text-sm font-semibold text-white mb-1">Join CulturalHub</p>
              <p className="text-xs text-white/40 mb-3">Like, comment and follow cultural sites.</p>
              <Link
                href={ROUTES.login}
...
//         {/* Center feed */}
//         <main className="flex-1 h-full overflow-y-auto bg-stone-900">
//           <div className="max-w-2xl mx-auto px-4 py-6">
//             {children}
//           </div>
//         </main>
...
// //   return (
// //     // Dark bg so the navbar blends naturally into the page
// //     <div className="h-screen bg-stone-900 flex flex-col overflow-hidden">

// //       {/* Shared navbar — passes search handler so Search button appears */}
// //       <TopNavbar onSearchOpen={() => setShowSearch(true)} />
...
// //         <aside className="hidden lg:flex w-72 h-full overflow-y-auto bg-stone-800 border-r border-white/10 flex-col px-4 py-5 gap-5 shrink-0">
...
// //               <Link
// //                 href={ROUTES.packages}
// //                 className="text-xs font-semibold text-amber-400/70 hover:text-amber-400 transition-colors px-1"
// //               >
// //                 See more →
// //               </Link>
// //             </div>
...
// //           {/* Sign in CTA — guests only */}
// //           {!isAuthenticated && (
// //             <div className="rounded-2xl bg-amber-400/10 border border-amber-400/20 px-4 py-4">
// //               <p className="text-sm font-semibold text-white mb-1">Join CulturalHub</p>
// //               <p className="text-xs text-white/40 mb-3">Like, comment and follow cultural sites.</p>
// //               <Link
// //                 href={ROUTES.login}
// //                 className="flex items-center justify-center gap-2 w-full text-center rounded-xl bg-amber-400 py-2 text-sm font-bold text-stone-900 hover:bg-amber-300 transition-all"
// //               >
// //                 <LogIn className="h-4 w-4" />
// //                 Sign in
// //               </Link>
...
// // //       {/* ── Unified Navbar (feed mode) ── */}
// // //       <TopNavbar feedMode onSearchOpen={() => setShowSearch(true)} />
...
// // // //   { label: "Notifications", href: ROUTES.touristNotifications, icon: Bell, authOnly: true },
