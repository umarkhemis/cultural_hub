...
//         <div className="flex gap-1.5">
//           {["bg-amber-300", "bg-amber-400", "bg-amber-500"].map((c, i) => (
//             <span key={i} className={`h-1.5 w-8 rounded-full ${c} opacity-60`} />
//           ))}
//         </div>
...
//             <span className="absolute inline-flex h-8 w-8 rounded-full bg-amber-300 opacity-30 animate-ping [animation-delay:150ms]" />
//             <span className="relative inline-flex h-4 w-4 rounded-full bg-amber-500" />
//           </div>
//           <p className="text-xs font-semibold tracking-widest uppercase text-stone-400 animate-pulse">
//             Loading more...
//           </p>
//         </div>
//       )}
