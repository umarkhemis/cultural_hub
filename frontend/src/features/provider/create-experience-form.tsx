      ...
      <div className="space-y-5 p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-semibold text-red-600">Required</span>
          </div>
          <MediaUploadField
        ...
        <div className="flex items-center justify-between border-t border-slate-100 pt-4">
          <p className="text-xs text-slate-400">Published experiences appear on the public feed.</p>
          <button
            type="button"
